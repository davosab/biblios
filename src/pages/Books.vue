  ...
  <div class="books-page ml-[200px]">
    ...
    <header class="page-header">
      <div class="header-left">
        ...
        <span class="book-count">{{ filteredBooks.length }} titles</span>
      </div>
    ...
    >
      ...
      >
        <div class="book-cover" :style="{ background: book.coverColor }">
          ...
          <div class="cover-badge" v-if="book.badge">{{ book.badge }}</div>
        </div>
        <div class="book-info">
          ...
          <div class="book-footer">
            ...
            <button class="add-to-cart" @click.stop="addToCart(book)">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
    ...
    <transition-group v-else name="book-fade" tag="div" class="books-list">
      <div
        ...
        @click="selectBook(book)"
      >
        <div class="list-cover" :style="{ background: book.coverColor }"></div>
        <div class="list-details">
          ...
          <span class="book-year list-year">{{ book.year }}</span>
          <span class="book-price list-price"
            >€{{ book.price.toFixed(2) }}</span
          >
          <button class="add-to-cart list-cart" @click.stop="addToCart(book)">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
...
const books = ref([
  ...
  },
  {
    ...
    year: 2018,
    badge: "Top Rated",
    coverColor: "linear-gradient(135deg, #1b1b1b 0%, #333 50%, #555 100%)",
  },
  {
    id: 6,
...
const genres = computed(() => [
  "All",
  ...new Set(books.value.map((b) => b.genre)),
]);
...
function selectBook(book) {
  // Emit or navigate to book detail — integrate with your router
