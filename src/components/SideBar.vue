...
<template>
    <div
        id="menu"
        class="fixed w-[200px] h-screen bg-surface flex flex-col border-r border-border"
    >
        ...
        <div class="px-4 pt-6 pb-4">
            <div class="text-center">
                ...
                <p
                    class="text-xs font-semibold text-[#78716c] uppercase tracking-wide"
                >
        ...
        <div class="flex flex-col flex-1 justify-between mt-2 px-2">
            <ul class="flex flex-col gap-2">
                <li
                    v-for="link in userRole === 'librarian'
                        ? librarianLinks
                        : studentLinks"
                    :key="link.path"
                >
